    ...
    while (1) {
        ...
        //==============================================================================================================================
            while (mark == 0) {
                ...
                /*char *command = (char*)realloc(command, sizeof(buffer));
                char *clientId = (char*)realloc(clientId, sizeof(buffer))*/;
                char command[1024];
                char clientId[1024];
