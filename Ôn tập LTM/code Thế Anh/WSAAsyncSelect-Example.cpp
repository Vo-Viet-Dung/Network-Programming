// WSAAsyncSelect Example.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "WSAAsyncSelect Example.h"
#include <WinSock2.h>

#define MAX_LOADSTRING 100
#define WM_ACCEPT WM_USER + 1 // dung tu gia tri WM_USER tro di vi truoc do da bi window ssu dung r
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   // co the thuc hien doan ma socket o doan nay truoc khi cua so duoc hien len
   ...
   WSAAsyncSelect(s, hWnd, WM_ACCEPT, FD_ACCEPT); // WM_ACCEPT la gia tri tu dinh nghia va dung de dinh danh message

   ShowWindow(hWnd, nCmdShow); // hien thi cua so
   UpdateWindow(hWnd);
